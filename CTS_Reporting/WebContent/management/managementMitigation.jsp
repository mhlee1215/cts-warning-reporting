...
<script>
  $(function() {
	  $( "#tabs_mitigation" ).tabs();
	  management_mitigation_load_report("id_managment_mitigation_hazard_to_be_mitigated_ListTable", "managementMitigationReportList.do?status=Risk");
	  management_mitigation_load_report("id_managment_mitigation_mitigated_hazards_ListTable", 	    "managementMitigationReportList.do?status=Mitigated");
  });
  ...
  function management_mitigation_load_report(id, url){
	  ...
	  jQuery("#"+id).jqGrid({
	  	...
	  	onSelectRow: function(rowid, status, e) {  		 
	  	    ...
	  	    //alert(localRowData);
	  		window.open('${pageContext.request.contextPath}/managementDetailMain.do?activateTab=4&hazard_no='+rowid,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=950,height=900');
	    }
...
<div id="tabs_mitigation">
  <ul>
    <li><a href="#tabs-1">${lang.getStringHazardsToBeMitigated()}</a></li>
    <li><a href="#tabs-2">${lang.getStringMitigatedHazards()}</a></li>
  </ul>
   <div id="tabs-1">
    <table>
<tbody>
<tr>
	<td align="center" width="723px;" ><table id="id_managment_mitigation_hazard_to_be_mitigated_ListTable" class="scroll" cellpadding="0" cellspacing="0"></table>
...
<tbody>
<tr>
	<td align="center" width="723px;" ><table id="id_managment_mitigation_mitigated_hazards_ListTable" class="scroll" cellpadding="0" cellspacing="0"></table>
	<div id="pager1" class="scroll"></div>
	</td>
</tr>
</tbody>
