...
<script>
  ...
  {
	var return_str = '<a id="id_taxi_in_seq_'+cellvalue+'_delete_hazard" href="#">Delete</a>';
	return_str += '<script>';
...
<legend class="l1_fieldset_legend">TAXI-IN INFORMATION</legend>
	...
	<tbody>
		...
		<tr>
			...
			<fieldset class="l2_fieldset">
				...
				<div style="width:100%;" align="right"><a id="id_report_taxi_in_attach_file_btn" href="#">Attach Files</a></div>
