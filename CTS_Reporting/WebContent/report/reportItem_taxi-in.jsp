...
<script>
  ...
  function fnFormatter( cellvalue, options, rowObject )
  {
	...
	return_str += '<script>';
	return_str += '$("#id_taxi_inseq_'+cellvalue+'_edit_hazard").button().click(function( event ) {'
...
<tr>
	...
	<td><select id="id_taxi_in_level_4_selector" name="method" class="hazard_item_selector">
	</select> </td>
</tr>
<tr>
