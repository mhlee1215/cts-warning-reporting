...
<script>
  ...
  {
	var return_str = '<a id="id_landing_seq_'+cellvalue+'_delete_hazard" href="#">${lang.getStringDelete()}</a>';
	return_str += '<script>';
...
<legend class="l1_fieldset_legend">LANDING ${lang.getStringInformation()}</legend>
	...
	<tbody>
		...
		<tr>
			...
			<fieldset class="l2_fieldset">
				...
				<div style="width:100%;" align="right"><a id="id_report_landing_attach_file_btn" href="#">${lang.getStringAttachFiles()}</a></div>
