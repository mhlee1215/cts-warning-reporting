...
<!-- <div id="mid_title"></div> -->
        ...
        <h2>Welcome to CTS Warning Reporting System</h2>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris iaculis nulla vitae ante congue iaculis. Nunc vitae sapien sed neque porttitor egestas sit amet ut ligula.</p>
    ...
    <div id="templatemo_fp_services" style="display:none">
    ...
    <div id="templatemo_main" style="display:none">
    
    	<div class="col_w620 float_r">
        	<h2>Who We Are</h2> 
            
            <img src="images/templatemo_image_01.jpg" class="image_wrapper image_fr" alt="banner" />
            
          	<p><em>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed elementum velit in tortor faucibus id tempus enim sodales. Vestibulum quam purus, euismod eget malesuada sit amet, condimentum id massa. </em></p>
          	
            <p align="justify"><a href="http://www.templatemo.com" target="_parent">Professional Template</a> is provided for your personal or commercial websites. Validate <a href="http://validator.w3.org/check?uri=referer" rel="nofollow"><strong>XHTML</strong></a> &amp; <a href="http://jigsaw.w3.org/css-validator/check/referer" rel="nofollow"><strong>CSS</strong></a>. Credits go to <a href="http://www.photovaco.com" target="_blank">Free Photos</a> for photos and <a href="http://www.vectorvaco.com" target="_blank">Free Vectors</a> for icons used in this template. Etiam magna metus, hendrerit non aliquam nec, tincidunt nec metus. Sed nec odio vel nulla pellentesque sodales a molestie nisi.</p>
      ...
      <div class="fp_news_box">
            	<img src="images/templatemo_image_03.jpg" alt="News One" />
            ...
            <div class="fp_news_box">
            	<img src="images/templatemo_image_02.jpg" alt="News Two" />
            ...
            <div class="fp_news_box">
            	<img src="images/templatemo_image_04.jpg" alt="News Three" />
