...
//		}
	...
	public Map<String, Map<String, Float> > getEffectiveness(String dateHeader, String initialRiskHeader, String residualRiskHeader, String actionHeader){
		...
		for(String action_code : codes){
			...
			Map<String, Float> averageInitialRiskByAction = this.getDateColumnAverageByCondition(dateHeader, initialRiskHeader, SMSAnalysisDateUtil.dateTypeMonth, actionHeader, action_code);
			Map<String, Float> averageResidualRiskByAction = this.getDateColumnAverageByCondition(dateHeader, residualRiskHeader, SMSAnalysisDateUtil.dateTypeMonth, actionHeader, action_code);
