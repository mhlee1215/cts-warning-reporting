...
<script>
  $(function() {
	  $("#id_report_take_off_attach_file_btn")
   ...
   $("#id_report_take_off_hazard_title").example('ex) Pax door impated airbridege while opening');
   $("#id_report_take_off_hazard_time").timepicker();
  
   
   texi_out_load_hazard_item();
   
   CKEDITOR.replace( 'report_take_off_narrative_ckeditor' );
   CKEDITOR.replace( 'report_take_off_recommendation_ckeditor' );
  });
  ...
  function texi_out_load_hazard_item(){
	  ...
	  jQuery("#id_take_off_attached_file_list_table").jqGrid({
	  	...
	  	loadComplete: function(){ 
	  			...
	  			//jQuery("#id_take_off_attached_file_list_table").setRowData(ids[i],{detail:detailHtml});				
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<tbody>
					<tr>
						<td width="10%"><input type="text" style="width:100%; height:12px;" name="" id="id_report_take_off_hazard_time" value=""/><td>
						<td width="5%" align="right"> <input type="radio" name="new_hazard" id="take_off_new_hazard_no" onchange="take_off_enable_description_of_new_hazard('n');" value="n" checked="checked"/></td>
						<td width="5%" align="left">Local</td>
						<td width="5%" align="right"> <input type="radio"name="new_hazard" id="take_off_new_hazard_yes" onchange="take_off_enable_description_of_new_hazard('y');" value="y"/></td>
