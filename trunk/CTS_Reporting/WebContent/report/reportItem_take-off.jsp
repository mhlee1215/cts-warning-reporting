...
<script>
  ...
  function take_off_fnFormatter( cellvalue, options, rowObject )
  {
	...
	return_str += '<script>';
	return_str += '$("#id_take_offseq_'+cellvalue+'_edit_hazard").button().click(function( event ) {'
...
<tr>
	...
	<td><select id="id_take_off_level_4_selector" name="method" class="hazard_item_selector">
	</select> </td>
</tr>
<tr>
