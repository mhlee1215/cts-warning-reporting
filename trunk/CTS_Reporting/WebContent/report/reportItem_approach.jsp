...
<script>
  ...
  {
	var return_str = '<a id="id_approach_seq_'+cellvalue+'_delete_hazard" href="#">Delete</a>';
	return_str += '<script>';
...
<legend class="l1_fieldset_legend">APPROACH INFORMATION</legend>
	...
	<tbody>
		...
		<tr>
			...
			<fieldset class="l2_fieldset">
				...
				<div style="width:100%;" align="right"><a id="id_report_approach_attach_file_btn" href="#">Attach Files</a></div>
