...
<script>
  $(function() {
   ...
   $("#id_en_route_edit_btn")
   .button()
   .click(function( event ) {
    event.preventDefault();
   });
   $("#id_en_route_cancel_btn")
   .button()
   .click(function( event ) {
    event.preventDefault();
   });
   $("#id_en_route_print_btn")
   .button()
   .click(function( event ) {
    event.preventDefault();
   });
   $("#id_en_route_submit_btn")
   .button()
   .click(function( event ) {
    event.preventDefault();
   });
  ...
  function en_route_enable_description_of_new_hazard(val){
	  if (val == 'y'){
...
<tr>
	...
	<td><select id="id_en_route_level_1_selector" onchange="read_hazard_item_list_children(this.value,1);" name="method" class="hazard_item_selector">		
	</select> </td>
</tr>
<tr>
	<td class="leftmost_label">Level2: </td>
	<td><select id="id_en_route_level_2_selector" onchange="read_hazard_item_list_children(this.value,2);" name="method" class="hazard_item_selector">
	</select> </td>
</tr>
<tr>
	<td class="leftmost_label">Level3: </td>
	<td><select id="id_en_route_level_3_selector" onchange="read_hazard_item_list_children(this.value,3);" name="method" class="hazard_item_selector">
	</select> </td>
</tr>
<tr>
...
<tr>
	...
	<td> <input type="radio" name="new_hazard" id="en_route_new_hazard_yes" onchange="en_route_enable_description_of_new_hazard('n');" value="n" checked="checked"/></td>
	<td style="width:30px;text-align:right;">Yes</td>
	<td> <input type="radio"name="new_hazard" id="en_route_new_hazard_no" onchange="en_route_enable_description_of_new_hazard('y');" value="y"/></td>
</tr>
</tbody>
</table>
<table>
...
<tbody>
<tr>
	<td align="right"><a id="id_en_route_edit_btn" href="#">Edit</a><a id="id_en_route_cancel_btn" href="#">Cancel</a><a id="id_en_route_print_btn" href="#">Print</a><a id="id_en_route_submit_btn" href="#">Submit</a><a id="id_en_route_save_btn" href="#">Save</a><a id="id_en_route_previous_btn" href="#">Previous</a><a id="id_en_route_next_btn" href="#">Next</a></td>
</tr>
</tbody>
</table>
</div>
