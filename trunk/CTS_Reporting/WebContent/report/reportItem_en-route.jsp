...
<script>
  ...
  {
	var return_str = '<a id="id_en_route_seq_'+cellvalue+'_delete_hazard" href="#">Delete</a>';
	return_str += '<script>';
...
<legend class="l1_fieldset_legend">EN-ROUTE INFORMATION</legend>
	...
	<tbody>
		...
		<tr>
			...
			<fieldset class="l2_fieldset">
				...
				<div style="width:100%;" align="right"><a id="id_report_en_route_attach_file_btn" href="#">Attach Files</a></div>
