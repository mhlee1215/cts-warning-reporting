...
<script>
  $(function() {
   ...
   $("#id_landing_cancel_btn")
   .button()
   .click(function( event ) {
    event.preventDefault();
   });
   $("#id_landing_print_btn")
   .button()
   .click(function( event ) {
    event.preventDefault();
   });
   $("#id_landing_submit_btn")
   .button()
   .click(function( event ) {
    event.preventDefault();
   });
  ...
  function landing_enable_description_of_new_hazard(val){
	  if (val == 'y'){
  ...
  {
	var return_str = '<a id="id_landingseq_'+cellvalue+'_edit_hazard" href="#">Edit</a>';
	return_str += '<script>';
	return_str += '$("#id_landingseq_'+cellvalue+'_edit_hazard").button().click(function( event ) {'
...
<tr>
	...
	<td><select id="id_landing_level_1_selector" onchange="read_hazard_item_list_children(this.value,1);" name="method" class="hazard_item_selector">		
	</select> </td>
</tr>
<tr>
	<td class="leftmost_label">Level2: </td>
	<td><select id="id_landing_level_2_selector" onchange="read_hazard_item_list_children(this.value,2);" name="method" class="hazard_item_selector">
	</select> </td>
</tr>
<tr>
	<td class="leftmost_label">Level3: </td>
	<td><select id="id_landing_level_3_selector" onchange="read_hazard_item_list_children(this.value,3);" name="method" class="hazard_item_selector">
	</select> </td>
</tr>
<tr>
	<td class="leftmost_label">Level4: </td>
	<td><select id="id_landing_level_4_selector" name="method" class="hazard_item_selector">
	</select> </td>
</tr>
<tr>
...
<tr>
	...
	<td> <input type="radio" name="new_hazard" id="landing_new_hazard_yes" onchange="landing_enable_description_of_new_hazard('n');" value="n" checked="checked"/></td>
	<td style="width:30px;text-align:right;">Yes</td>
	<td> <input type="radio"name="new_hazard" id="landing_new_hazard_no" onchange="landing_enable_description_of_new_hazard('y');" value="y"/></td>
</tr>
</tbody>
</table>
<table>
...
<tbody>
<tr>
	<td align="right"><a id="id_landing_edit_btn" href="#">Edit</a><a id="id_landing_cancel_btn" href="#">Cancel</a><a id="id_landing_print_btn" href="#">Print</a><a id="id_landing_submit_btn" href="#">Submit</a><a id="id_landing_save_btn" href="#">Save</a><a id="id_landing_previous_btn" href="#">Previous</a><a id="id_landing_next_btn" href="#">Next</a></td>
</tr>
</tbody>
</table>
</div>
